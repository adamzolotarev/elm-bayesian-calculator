...
Elm.Calculator.make = function (_elm) {
   "use strict";
   _elm.Calculator = _elm.Calculator || {};
   if (_elm.Calculator.values) return _elm.Calculator.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return model;
         case "UpdateInitialProbability": return _U.update(model,
           {priorProbability: _p0._0});
         case "UpdateHitRate": return _U.update(model,{hitRate: _p0._0});
         default: return _U.update(model,{falseAlarmRate: _p0._0});}
   });
   ...
   return _elm.Calculator.values = {_op: _op
                                   ...
                                   ,NoOp: NoOp
                                   ,UpdateInitialProbability: UpdateInitialProbability
