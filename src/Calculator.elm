...
priorProbabilityItem model =
    [ label [ for "priorProbability", class "col-md-3 control-label" ]
...
hitRateItem model =
    [ label [ for "hitRate", class "col-md-3 control-label" ]
        [ text "Hit Rate" ]
    , div [ class "col-md-9" ]
        [ input
            [ type' "text"
...
falseAlarmItem model =
    [ label [ for "falseAlarmRate", class "col-md-3 control-label" ]
...
resultItem model =
    [ label [ for "bayesResult", class "col-md-3 control-label" ]
